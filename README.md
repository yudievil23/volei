...
<head>
    ...
    <title>Vôlei Digital Album</title>
...
<body class="p-4 md:p-8">
    ...
    <div class="max-w-6xl mx-auto">
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 border-b border-orange-600/30 pb-6 gap-4">
            <div>
                <h1 class="text-4xl font-tech font-bold text-orange-500 tracking-tighter">VÔLEI <span class="text-white">ALBUM</span></h1>
        ...
        <section class="mb-10 bg-[#1a1a1a] p-6 rounded-xl border border-gray-800">
            ...
            <div class="flex flex-col gap-4">
                <textarea id="playerPool" placeholder="Insira nomes separados por vírgula ou linha..." class="bg-black border border-gray-700 p-3 rounded text-sm h-24 focus:border-orange-500 outline-none"></textarea>
                ...
                <div class="flex justify-between items-start mb-4">
                    <div class="flex-1">
                        <div class="flex items-center gap-2">
                            ...
                            <button onclick="deleteTeam(this)" class="text-gray-600 hover:text-red-500 text-xs">✕</button>
                        </div>
    ...
    <script>
        ...
        function render() {
            ...
            // Ordenação: Vencedor primeiro, depois por quadra, depois o resto
